...
int main()
{
    ...
    glAttachShader(shaderProgram, vertexShader);      //both fragment shaders can be used,
    glAttachShader(shaderProgram, fragmentShaderx);   //just add or remove the x here  
