...
int main()
{
    ...
    glAttachShader(shaderProgram, fragmentShader);        //simply make this fragmentshaderx
    ...
    GLfloat vertices[] = {
        //vertices          //colors
       -0.6, 0.75, 0.0,     0.0f, 0.4f, 0.8f,
        0.8, 0.3,  0.0,     0.2f, 0.5f, 0.0f,
        0.0, 0.0,  0.0,     0.8f, 1.0f, 0.0f,
    };
